...
轻量应用云主机提供的计算资源同UCloud云主机相同，通常适用于支撑小型Web应用、博客、论坛、店铺管理、云端开发/测试/学习环境等轻量级、低负载且访问量适中的应用场景。
...
| **包含镜像** | CentOS、Ubuntu、Windows、Debian、Rocky | WooCommerce、WordPress、Palworld-server、宝塔、我的世界、我的世界-server、DeepSeek-R1 1.5B、OpenClaw |
